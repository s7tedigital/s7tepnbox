...
def quanti_node(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    system_prompt = SystemMessage(
        content=(
            ...
            "1. INVESTIMENTO FIXO: Liste todos os itens de investimento fixo com valores em R$.\n"
            ...
            "5. DRE MENSAL (12 MESES): Para CADA mês de 1 a 12, projete:\n"
            "   - Receita Bruta\n"
            "   - Deduções (impostos ~15%)\n"
            "   - Receita Líquida\n"
            "   - Custos Variáveis\n"
            "   - Margem de Contribuição\n"
            "   - Custos Fixos\n"
            "   - Lucro/Prejuízo Operacional\n"
            "   Use crescimento orgânico realista (ex: 10-20% mês a mês nos primeiros meses).\n"
            "6. INDICADORES: Calcule com precisão:\n"
            "   - Lucratividade (%)\n"
            "   - Rentabilidade (%)\n"
            "   - Payback (meses)\n"
            "   - Ponto de Equilíbrio em R$ e em unidades/assinaturas\n"
            "   - ROI anual (%)\n\n"
            "Se o usuário não forneceu números exatos, use padrões da indústria brasileira.\n"
